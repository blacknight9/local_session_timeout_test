  ...
  Widget build(BuildContext context) {
    ...
    sessionConfig.stream.listen((SessionTimeoutState timeoutEvent) {
      if (timeoutEvent == SessionTimeoutState.userInactivityTimeout) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('userInactivityTimeout, userInactivityTimeout')));


      } else if (timeoutEvent == SessionTimeoutState.appFocusTimeout) {
        // handle user  app lost focus timeout
        // Navigator.of(context).pushNamed("/auth");
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('appFocusTimeout, appFocusTimeout')));
